...
Since [@StoredProcedure](../../tutorials/stored-proc-tutorial.md) functions must be tied to a specific [application version](../../tutorials/workflow-tutorial.md#workflow-versioning-and-recovery), both DBOS Transact and the DBOS Compiler are version aware. 
