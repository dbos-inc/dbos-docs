...
Any workflow or step can call [`DBOS.set_event`](../reference/contexts.md#set_event) to publish a key-value pair, or update its value if it has already been published.
#### get_event
