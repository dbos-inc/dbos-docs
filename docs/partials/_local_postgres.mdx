...
<TabItem value="cloud" label="Use Cloud Postgres">

If you followed the steps above to deploy an application to DBOS Cloud, you can run your app locally using a cloud-hosted database server.
...
Then connect your local app to your cloud database.
