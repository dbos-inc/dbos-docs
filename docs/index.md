...
- **Build with DBOS Transact** - An open-source framework for building resilient backend applications in [TypeScript](https://github.com/dbos-inc/dbos-transact) and [Python](https://dbos.dev/python).
...
| Feature                                                                       | Description
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| [Transactions](https://dbos.dev/python)                                       | Easily and safely query your application database using [SQLAlchemy](https://www.sqlalchemy.org/) or raw SQL.
| [Reliable Workflows](https://dbos.dev/python)                                 | Execute each step of your application exactly-once and automatically resume after any failure.
| [HTTP Serving](https://dbos.dev/python)                                       | Leverage [FastAPI](https://fastapi.tiangolo.com/) to serve requests from your application.
| [Communicators](https://dbos.dev/python)                                      | Reliably interact with external services and third-party APIs.
| [Idempotency](https://dbos.dev/python)                                        | Automatically make any request idempotent, so your requests happen exactly once.
| [Kafka Integration](https://dbos.dev/python)                                  | Consume Kafka messages exactly-once with transactions or workflows.
| [Scheduled Workflows](https://dbos.dev/python)                                | Schedule your workflows to run exactly-once per time interval with cron-like syntax.
| [Self-Hosting](https://dbos.dev/python)                                       | Host your applications anywhere, as long as they have a Postgres database to connect to.
